...
public class GameTaiXiuActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game_taixiu);
        intView();
        initData();
        clearData();
    }
    ...
    private void intView() {
        ...
        tvHuongDanAnalyzer = this.findViewById(R.id.tvHuongDanAnalyzerTaiXiu);

        tvTableName = this.findViewById(R.id.tvNameTableTaiXiu);
        tvResultForChanLe = this.findViewById(R.id.tvResultForChanLeTaiXiu);
        tvResultForToBe = this.findViewById(R.id.tvResultForToBeTaiXiu);
        tvTitleNhapTenBan = this.findViewById(R.id.tvTitleNhapTenBanTaiXiu);

        tvBeResult = this.findViewById(R.id.tvBeResultTaiXiu);
        tvChanResult = this.findViewById(R.id.tvChanResultTaiXiu);
        tvLeResult = this.findViewById(R.id.tvLeResultTaiXiu);
        tvToResult = this.findViewById(R.id.tvToResultTaiXiu);
        llBorderAnalyzer = this.findViewById(R.id.llBorderAnalyzerTaiXiu);
        llActivityAnalyzer = this.findViewById(R.id.llActivityAnalyzerTaiXiu);

        progressDialog = new ProgressDialog(GameTaiXiuActivity.this);
    ...
    private void initData() {
        preferences = new MySharedPreferences(GameTaiXiuActivity.this);
        ...
        //Set text guide
        if (NetworkUtils.haveNetwork(GameTaiXiuActivity.this)) {
            ...
            databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    if (settingModel != null) {
                        tvHuongDanAnalyzer.setText(settingModel.getHuongDanTaiXiu());
                    }
                }
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btnAnalyzerTaiXiu) {
            if (NetworkUtils.haveNetwork(GameTaiXiuActivity.this)) {
                ...
                Toast.makeText(GameTaiXiuActivity.this, getResources().getString(R.string.check_connection_network), Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private boolean validateTableCodeInput(String tableCode) {
        if (tableCode.isEmpty()) {
            Toast.makeText(GameTaiXiuActivity.this, "Vui lòng nhập tên bàn trước", Toast.LENGTH_SHORT).show();
            hideKeyboard();
            return false;
        }
        return true;
