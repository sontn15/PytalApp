...
public class SoiCauMienTrungFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener, View.OnClickListener {
    private View mView;

    private FloatingActionButton fabSoiCauMt;
    private SwipeRefreshLayout refreshLayout;
    private TextView tvDateNewest, tvSongThuLoNewest, tvBachThuLoNewest;
    private RecyclerView rcvSoiCauMt;
    private List<SoiCau> listSoiCaus, listSoiCausClone;
    private SoiCauAdapter soiCauAdapter;
    private ProgressDialog progressDialog;

    private View viewDialog;
    private AlertDialog soiCauMtDlg;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mView = inflater.inflate(R.layout.fragment_manager_soicau_mt, container, false);
        initView();
        initAdapter();
        initSoiCauMtDialog();
    ...
    private void initView() {
        fabSoiCauMt = mView.findViewById(R.id.fabSoiCauMt);
        rcvSoiCauMt = mView.findViewById(R.id.rcvSoiCauMt);
        tvDateNewest = mView.findViewById(R.id.tvCreatedNewestSoiCauMt);
        tvBachThuLoNewest = mView.findViewById(R.id.tvBachThuLoNewestSoiCauMt);
        tvSongThuLoNewest = mView.findViewById(R.id.tvSongThuLoNewestSoiCauMt);
        refreshLayout = mView.findViewById(R.id.refreshSoiCauMt);
        refreshLayout.setOnRefreshListener(this);

        LinearLayoutManager layoutManager = new LinearLayoutManager(requireActivity());
        layoutManager.setOrientation(RecyclerView.VERTICAL);
        rcvSoiCauMt.setLayoutManager(layoutManager);

        progressDialog = new ProgressDialog(requireActivity());
        progressDialog.setMessage(getResources().getString(R.string.vui_long_doi) + "...");
        progressDialog.setCanceledOnTouchOutside(false);

        fabSoiCauMt.setOnClickListener(this);
    }
    ...
    private void initAdapter() {
        ...
        rcvSoiCauMt.setAdapter(soiCauAdapter);
        buildAllSoiCau();
    ...
    private void buildAllSoiCau() {
        if (NetworkUtils.haveNetwork(requireActivity())) {
            ...
            DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference().child(Const.FIREBASE_REF.SOI_CAU_MT);
    ...
    private void initSoiCauMtDialog() {
        soiCauMtDlg = new AlertDialog.Builder(requireActivity(), R.style.CustomAlertDialog).create();
        viewDialog = getLayoutInflater().inflate(R.layout.dialog_new_soicau_mt, null);

        tvDateCurrentDlg = viewDialog.findViewById(R.id.tvDateTimeSoiCauMt);
        ...
        soiCauMtDlg.setView(viewDialog);
    ...
    private void onClickFabSoiCauMt() {
        clearDataDialog();
        showSoiCauMtDialog();
    }
    ...
    private void onClickAgreeDialog() {
        ...
        if (NetworkUtils.haveNetwork(requireActivity())) {
            ...
            final SoiCau soiCauCreated = SoiCau.builder()
                    ...
                    .mien(Const.SOI_CAU_BA_MIEN.MIEN_TRUNG)
            ...
            final DatabaseReference mDatabase = FirebaseDatabase.getInstance().getReference(Const.FIREBASE_REF.SOI_CAU_MT);
    ...
    private void showSoiCauMtDialog() {
        if (soiCauMtDlg != null && !soiCauMtDlg.isShowing()) {
            soiCauMtDlg.show();
        }
    }

    private void hiddenSoiCauMtDialog() {
        if (soiCauMtDlg != null && soiCauMtDlg.isShowing()) {
            soiCauMtDlg.dismiss();
        }
    }
